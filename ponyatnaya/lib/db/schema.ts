...
export const product = pgTable("product", {
  ...
  additives: text("additives").notNull().default(""),
  shelfLife: text("shelf_life").notNull().default(""),
  storageConditions: text("storage_conditions").notNull().default(""),
  regulatoryDocuments: text("regulatory_documents").notNull().default(""),
