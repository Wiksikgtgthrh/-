              ...
              {user ? (
                <div className="relative">
                  ...
                  <AnimatePresence>
                    {accountMenuOpen && (
                      <>
                        {/* Оверлей для закрытия по тапу вне меню (обязательно для телефонов) */}
                        <button
                          type="button"
                        ...
                        <motion.div
                          ...
                          className="absolute right-0 z-50 mt-2 w-48 rounded-xl border border-gray-100 bg-white py-2 shadow-lg"
                        >
                          <Link
                            to="/account"
                            onClick={() => setAccountMenuOpen(false)}
