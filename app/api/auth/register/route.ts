...
export async function POST(req: Request) {
  // Защита от массовой регистрации: не более 5 регистраций в час с одного IP.
  if (isRateLimited(`register:${clientIp(req)}`, 5, 60 * 60_000)) {
    return fail("Слишком много попыток регистрации. Попробуйте позже.", 429)
  }
